        ...
        <div>
            ...
            <div className="col-12">
                ...
                <div className="pt-4">
                    ...
                    <b>Cross-Origin Resource</b> Sharing (CORS) is an HTTP-header based mechanism that allows a server to indicate any origins (domain, scheme, or port) other than its own from which a browser should permit loading resources. CORS also relies on a mechanism by which browsers make a "preflight" request to the server hosting the cross-origin resource, in order to check that the server will permit the actual request. In that preflight, the browser sends headers that indicate the HTTP method and headers that will be used in the actual request.
                    <br></br>
                    <br></br>
            ...
            <div className='container row mx-auto rounded border mt-5 p-3 mb-4'>
            <div className="col-12">
                <h1 className='ff-poppins fw-bolder'>Blog-2: Why you are using firebase?</h1>
                <div className="pt-4">
                    <p className='text-start'>
                    <b>Google Firebase</b> is an application development platform that allows developers to create iOS, Android, and Web apps. Here's why I am use firebase!<br></br><br></br>
                    Indeed, Firebase is a less technical and time-saving alternative to writing full-fledged backend code for dynamic apps. You might also want to consider leveraging this tool if you eventually wish to host and manage your app in the cloud. Being serverless, Firebase removes the need to worry about the technicalities of cloud server configuration.<br></br>
                    As a Google Cloud service, it also gives you access to other Google products and features, like Google Drive and Sheets. For instance, you can import dummy data from Google Sheets and use it temporarily to serve your app.<br></br><br></br>
                    ...
                    <br></br>
                    <br></br>
                    All of these can save you a significant amount of development cost, as you don't need to pay as high as developing from scratch. Firebase pricing is equally flexible. Although there are pay-as-you-go services, you can start on a free plan and use primary features if your app is still at its prime.<br></br> 
            ...
            <div className='container row mx-auto rounded border mt-5 p-3 mb-4'>
            <div className="col-12">
                <h1 className='ff-poppins fw-bolder'>Blog-3: How does the private route work?</h1>
                <div className="pt-4">
                    <p className='text-start'>
                    The <b>Private Route</b> component is similar to the public route, the only change is that redirect URL and authenticate condition. If the user is not authenticated he will be redirected to the login page and the user can only access the authenticated routes If he is authenticated<br></br><br></br>
            ...
            <div className='container row mx-auto rounded border mt-5 p-3 mb-4'>
            <div className="col-12">
                <h1 className='ff-poppins fw-bolder'>Blog-4: What is Node? How does Node work?</h1>
                <div className="">
                    <div className='text-start pt-4'>
                    <h4>What is Node?</h4>
                    A node is a basic unit of a data structure, such as a linked list or tree data structure. Nodes contain data and also may link to other nodes. Links between nodes are often implemented by pointers.<br></br><br></br>
